...
export default {
    ...
    methods: {
        async getShop() {
            const getData = await this.$axios.get("http://127.0.0.1:8000/api/v1/stores/" + this.$route.params.shop_id);
        ...
        async reserve() {
            ...
            await this.$axios.post("http://127.0.0.1:8000/api/v1/reservations/", sendData);
