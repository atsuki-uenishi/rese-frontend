...
export default {
    ...
    methods: {
        async getShop() {
            const getData = await this.$axios.get("APP_BASE_API/api/v1/stores/" + this.$route.params.shop_id);
        ...
        async reserve() {
            ...
            await this.$axios.post("APP_BASE_API/api/v1/reservations/", sendData);
